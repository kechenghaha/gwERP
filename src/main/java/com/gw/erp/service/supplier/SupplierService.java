...
import com.gw.erp.datasource.mappers.SupplierMapper;
import com.gw.erp.datasource.mappers.SupplierMapperEx;
import com.gw.erp.exception.BusinessRunTimeException;
import com.gw.erp.exception.GwException;
import com.gw.erp.service.accountHead.AccountHeadService;
import com.gw.erp.service.depotHead.DepotHeadService;
...
import static com.gw.erp.utils.Tools.getNow3;
...
public class SupplierService {
    ...
    public int batchDeleteSupplierByIdsNormal(String ids) throws Exception {
        /**
         * 校验
         * 1、财务主表	gw_accounthead
         * 2、单据主表	gw_depot_head
         * 是否有相关数据
         * */
        int deleteTotal=0;
